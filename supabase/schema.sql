...
-- =============================================================================
-- 4b. DAILY PLAN EXTRA TASKS  (unlimited extra tasks for today)
-- =============================================================================
...
begin
  foreach t in array array[
    'profiles','projects','tasks','daily_plans','daily_plan_extra_tasks','energy_tasks','daily_reviews','cash_targets','subtasks'
  ]
  loop
    execute format(
